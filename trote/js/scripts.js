function calcular(){
    ...
    // declaracao variavel sem tipo
    let soma=0,acaoSocial,homenagem,leite,kit,suplemento,pontosKitSupl=0, sangue, equipe, pontosSangue=0
    ...
    pontosKitSupl=0 //guarda pontuacao do kit 
    if (equipe== "Laranja"){
        ...
        else if (kit>=52&& suplemento >=22){
        pontosKitSupl=2500+((kit-52)*30)+((suplemento-22)*15)
        }
        ...
        if(Number(kit)>=102&& suplemento >=51){
            pontosKitSupl=5000+((kit-97)*30)+((suplemento-51)*15)
        }
        ...
        if((kit)>=88&& suplemento >=51){
            pontosKitSupl=5000+((kit-97)*30)+((suplemento-51)*15)
         }
         else if (kit>=70&& suplemento >=41){
             pontosKitSupl=4000+((kit-82)*30)+((suplemento-41)*15)
         }
        else if (kit>=44&& suplemento >=26){
             pontosKitSupl=2500+((kit-51)*30)+((suplemento-26)*15)
         }
